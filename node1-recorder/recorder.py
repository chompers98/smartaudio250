...
#            print(f"Node 2 Connection Failed: {e}")
    ...
    def calculate_db(self, audio_data):
        # return -inf to represent silence
    ...
    # calibrate threshold based on environmental noise
    def measure_noise_floor(self, duration=5):
        ...
        for i in range(total_samples):
            ...
            # show user progress of calibration
    ...
    # transmit audio to node 2 (processor)
